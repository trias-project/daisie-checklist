...
```{r}
taxon %<>% mutate(dwc_scientificName =
                    paste(genus, species, authority, subtaxon, subtaxon_authority, sep = " ")
)
```
...
7. Specify the values of `idspecies` to be removed from the taxon core
