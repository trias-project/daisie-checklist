...
```{r}
distribution$idspecies <- 
  with(distribution, 
       mapvalues(x = idspecies, 
                 from = remove_taxa$idspecies, 
                 to = remove_taxa$replacement_idspecies))
```
...
3. Export `sp_in_region_with_location` as .csv
