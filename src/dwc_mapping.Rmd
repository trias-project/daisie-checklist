...
```{r}
taxon %<>% mutate(dwc_language = "my_language") 
```

### license

```{r}
taxon %<>% mutate(dwc_license = "my_license") 
```

### rightsHolder

```{r}
taxon %<>% mutate(dwc_rightsHolder = "my_rights_holder")
```
...
```{r}
taxon %<>% mutate(dwc_institutionCode = "my_institution_code") 
```

### datasetName

```{r}
taxon %<>% mutate(dwc_datasetName = "my_dataset_title") 
```
