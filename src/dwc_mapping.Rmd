...
distribution_references %<>% mutate(source_distribution = paste(distribution, `general references`, `introduction dates`, `introduction history`, sep = "|")) 
```
...
region_first_record <- distribution %>% 
  ...
  distinct(id_sp_region, .keep_all = TRUEe)
```
